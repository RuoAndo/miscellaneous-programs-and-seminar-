...
python store_gtags_f_flist-android.py flist.csv $saturator_minor_version $pwd3 $mongodb_ip
...
python extract_callers-android.py list-callchain.csv $saturator_minor_version $pwd3 $mongodb_ip $mongodb_ip
